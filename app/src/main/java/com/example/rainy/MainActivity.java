...
>>>>>>> Stashed changes
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // This is the code to run when the button is clicked
...
// Add the request to the Volley queue
    ...
    private void getWeatherDataUsingCoordinates(double latitude, double longitude) {
        ...
        intent.putExtra("lat", latitude); // For example, passing a string value
        intent.putExtra("longe", longitude); // For example, passing a float value
